...
const aiInsights = [
  {
    ...
    description:
      "Your SOC 2 compliance score is projected to reach 96% by end of Q2 based on current remediation velocity.",
    action: "View Details",
  },
  {
    type: "recommendation",
    ...
    description:
      "Access Review control is failing across multiple frameworks. AI suggests consolidating evidence collection.",
    action: "Fix Now",
  },
  {
    type: "alert",
    ...
    description:
      "Annual ISO 27001 audit scheduled in 14 days. 3 evidence items are still pending.",
    action: "Prepare",
  },
];
...
const recentActivity = [
  {
    action: "Control test completed",
    item: "AC-001: Access Control Policy",
    time: "2 hours ago",
    user: "Sarah Chen",
  },
  {
  ...
  },
  {
    ...
    item: "RISK-2024-012: Legacy system vulnerability",
    time: "6 hours ago",
    user: "Emily Davis",
  },
  {
    action: "Finding remediated",
    item: "FIND-089: Missing encryption at rest",
    time: "1 day ago",
    user: "Tom Wilson",
  },
];
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { icon: Shield, label: "Start Risk Assessment", href: "/risk-management/risk-assessment" },
              { icon: Target, label: "Review Controls", href: "/controls" },
              { icon: CheckCircle2, label: "Upload Evidence", href: "/evidence" },
              { icon: FileText, label: "Generate Report", href: "/audit/reports" },
            ].map((action) => (
