...
export default function AddPolicyPage() {
  ...
  return (
    <AppLayout mainClassName="p-0 bg-gray-50">
                ...
                >
                  ...
                  <div className="mt-6 p-3 bg-amber-50 rounded-lg flex items-start gap-3 text-left max-w-md mx-auto">
                    ...
                    <div className="text-sm text-amber-800">
                      ...
                      <p className="mt-1">
                        After upload AI will automatically detect content,
                        reference requirements, and suggest framework mapping.
                      </p>
                    </div>
                  </div>
              ...
              <DialogContent className="max-w-md">
                <div className="flex flex-col items-center text-center py-4">
                  ...
                  <DialogDescription className="text-sm text-gray-600 mb-6">
                    By cancelling this, you will lose all the progress and this
